    ...
    <div>
      <Container style={{ maxWidth: "800px" }}>
        <Form>
          ...
          <Form.Group className="mb-3" controlId="eligibilityCriteria">
            <Form.Label>
          ...
          <Form.Group className="mb-3" controlId="ppt">
            ...
            <Form.Check type="radio" label="Yes" name="pptRadio" id="pptYes" />
            <Form.Check type="radio" label="No" name="pptRadio" id="pptNo" />
          </Form.Group>
          <Form.Group className="mb-3" controlId="shortlistFromResumes">
          ...
          <Form.Group className="mb-3" controlId="writtenTestOnlineTest">
          ...
          <Form.Group className="mb-3" controlId="groupDiscussion">
            ...
            <Form.Label>Personal Interview/ Number of Rounds</Form.Label>
            <Form.Check
              type="radio"
              label="Yes"
              name="groupDiscussionRadio"
          ...
          <Form.Group className="mb-3" controlId="numberOfOffers">
            <Form.Label>Number of offers you intend to make</Form.Label>
            <Form.Control type="number" placeholder="Enter number of offers" />
          </Form.Group>

          {/* Preferred period for recruitment  */}

          <Form.Group className="mb-3" controlId="preferredPeriod">
            <Form.Label>Preferred period for recruitment</Form.Label>
            <Form.Control type="text" placeholder="Enter preferred period" />
          </Form.Group>
