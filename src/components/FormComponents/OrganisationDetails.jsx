...
function OrganisationDetails({ formState, setFormState, handleSubmit }) {
                ...
                <Container>
                    ...
                    <div className="note-container">
                        ...
                        >
                            ...
                            <Form.Control
                                ...
                                name="organisation"
                                value={
                                    formState.about_organisation.organisation
                                }
                        ...
                        <Form.Group className="mb-3" controlId="postalAddress">
                            ...
                            <Form.Control
                                ...
                                name="postal_address"
                                value={
                                    formState.about_organisation.postal_address
                                }
                    ...
                    <div className="note-container">
                        ...
                        <InputGroup className="mb-3">
                            <InputGroup.Text id="organisationTypeOther">
                                Others
                            </InputGroup.Text>
                            <Form.Control
                    ...
                    <div className="note-container">
                        ...
                        <InputGroup className="mb-3">
                            ...
                            <Form.Control
                                ...
                                onChange={(e) =>
                                    handleOthers(e, "industry_sector")
                                }
                                placeholder="Specify other type"
                            />
                        </InputGroup>
